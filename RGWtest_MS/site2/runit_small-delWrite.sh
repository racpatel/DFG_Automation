...
testname=bb-delWrite-site2-$comment
...
echo `date +%y/%m/%d" "%H:%M` " bb-delWrite ..."
./runIOworkload-site2.sh bb-deleteWrite2hr.xml
...
#if [[ $cephadmshell != "true" ]]; then
#    echo " " | mail -s "RGWtest site2 bb-delWrite (${jobId}) complete" <email.address>
#fi
