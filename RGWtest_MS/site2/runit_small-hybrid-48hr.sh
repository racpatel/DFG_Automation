...
testname=bb-hybrid48hr-site2-$comment
...
echo `date +%y/%m/%d" "%H:%M` " bb-bybrid-48hr ..."
./runIOworkload-site2.sh bb-hybridSS-48hr.xml
...
#if [[ $cephadmshell != "true" ]]; then
#    echo " " | mail -s "RGWtest site2 bb-hybrid-ext (${jobId}) complete" <email.address>
#fi
