...
testname=bb-hybrid-site2-$comment
...
echo `date +%y/%m/%d" "%H:%M` " bb-bybrid ..."
./runIOworkload-site2.sh bb-hybridSS.xml
...
#if [[ $cephadmshell != "true" ]]; then
#    echo " " | mail -s "RGWtest site2 bb-hybrid (${jobId}) complete" <email.address>
#fi
